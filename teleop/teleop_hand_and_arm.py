...
from teleop.robot_control.robot_hand_inspire_dftp import Inspire_Controller_FTP
    ...
    try:
        ...
        if args.sim:
            ...
            img_config = {
                ...
                'head_camera_image_shape': [480, 640],  # Head camera resolution
                'head_camera_id_numbers': ['335622072760'],
                #'wrist_camera_type': 'opencv',
                #'wrist_camera_image_shape': [480, 640],  # Wrist camera resolution
                #'wrist_camera_id_numbers': [2, 4],
            }
        ...
        if WRIST and args.sim:
            ...
            img_client = ImageClient(tv_img_shape = tv_img_shape, tv_img_shm_name = tv_img_shm.name, server_address = "192.168.1.151")
